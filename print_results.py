...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("\n\n*** Results Summary for CNN Model Architectue",model.upper(),"***")
    print("{:20}: {:3d}".format("N Images",results_stats_dic["n_images"]))
    print("{:20}: {:3d}".format("N_Dogs_Images",results_stats_dic["n_dogs_img"]))
    print("{:20}: {:3d}".format("N_Not-Dogs_Images",results_stats_dic["n_notdogs_img"]))
    ...
    print("{:20}: {:3d}".format("% Correct 'Not-a' Dog",
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            if sum(results_dic[key][3:])==1:
                print("Original: {:>26}   Classifier: {:>30}"
